 ...
 */
package br.edu.ifpe.salaonete.model.hibernateUtil;
...
public class HibernateUtil {
    ...
    private static SessionFactory buildSessionFactory(){
        try{
            ...
            ServiceRegistry servicoRegistry = new StandardServiceRegistryBuilder().
                    applySettings(configuration.getProperties()).build();
            SessionFactory sesionFactory = configuration.buildSessionFactory(servicoRegistry);
            
            return sessionFactory;
        }catch(Throwable ex){
            System.out.println("Falha ao tentar criar o SessionFactory()"+ex);
